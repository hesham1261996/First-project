@extends('layouts.app', ['title' => __('Quizes Management')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Quizes Management') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('quizzes.update' , $quiz) }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
                            
                            <h6 class="heading-small text-muted mb-4">{{ __('Quizes information') }}</h6>
                            <div class="pl-lg-4">
